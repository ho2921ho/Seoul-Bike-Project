...
os.chdir("C:/Users/renz/Documents/GitHub/Seoul-Bike-Project/Seoul open data")
names = listdir("C:/Users/renz/Documents/GitHub/Seoul-Bike-Project/Seoul open data/.raw data") # error point 폴더 안에 데이터만 있어야한다.
print(names)
...
table_names = ['bustn_loc','green_loc','lib_loc','stn_loc']
